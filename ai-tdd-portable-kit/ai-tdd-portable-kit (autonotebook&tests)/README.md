...
docs/
  ...
  decisions-log.md
  adr/
    001-ejemplo-decision.md
  templates/
    file-upload-feature.md
    gps-integration.md
...
2. Copy or merge `CONTRIBUTING.md`.
3. Add or merge `docs/roadmap.md`.
4. Add or merge `docs/decisions-log.md`.
5. Add or merge `docs/adr/` directory with your ADRs.
6. Add or merge `docs/templates/` for reference.
7. Add or merge `docs/ai/00_orquestacion_arquitectura_ia.md`.
8. Add or merge `docs/ai/notebook_context_index.md`.
9. Add or merge `docs/ai/outputs/reporte_fase_actual.md`.
10. Copy `tools-ai/notebooklm/`.
11. Add local runtime paths to `.gitignore`.
...
The kit includes ready-to-use templates for common development scenarios:

### Technical documentation
- `docs/adr/001-ejemplo-decision.md` - Architectural Decision Record template
- `docs/decisions-log.md` - Decision log with learning entries
- `CONTRIBUTING.md` - Contribution guide with TDD/YAGNI workflow

### Feature implementation guides
- `docs/templates/file-upload-feature.md` - File upload (PDF, CSV, DOCX, XLSX, TXT)
- `docs/templates/gps-integration.md` - GPS/location integration
- `docs/templates/ai-api-integration.md` - AI API integration (OpenRouter, OpenAI, Anthropic)

Use these templates as reference when implementing new features. Adapt them to your project's specific needs.
...
[ ] Copy or merge CONTRIBUTING.md.
[ ] Copy or merge docs/decisions-log.md.
[ ] Create docs/adr/ directory with your ADRs.
[ ] Review docs/templates/ for feature implementation guides.
